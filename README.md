...
## Features
- Gives each user (or a defined subset thereof) in your organisation remote desktop access to a Linux-based development environment, with a selection of programming languages, libraries, IDEs, tools and utilities installed in a ready-to-use setup.
